...
$default_fd['gallery3']['layout'] = array(
        ...
        'fd_options' => "square\nmagazine\njgallery\ncustom",
        'fd_default' => 'square',
        'fd_help' => "Layout format for the gallery: Square = squared thumbs to full-size via lightbox, Magazine = fullsize formatted into a single layout, JGallery = thumbs clickable to update inline fullsize image, Custom = a custom-defined layout",
        'fd_order' => $o++,
        'fd_tabname' => "Content",
    );
...
$default_td['gallery3_image'] = array(
        ...
        'td_orderbyfields' => "gi_order, gi_date, gallery3_imageid",
